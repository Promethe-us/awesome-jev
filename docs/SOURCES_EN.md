...
> Audit date: **2026-09-22, Asia/Shanghai (UTC+8)**; **two incremental updates plus a full link audit completed on 2026-09-24** (see the 09-24 rows in the key-facts table). The repository's master label and the [research guide](RESEARCH_EN.md) audit date are now **2026-09-24 (Asia/Shanghai)**.
