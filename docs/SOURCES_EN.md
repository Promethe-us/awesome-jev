...
> Audit date: **2026-09-22, Asia/Shanghai (UTC+8)**; **two incremental updates on 2026-09-24** — the first added 13 arXiv papers (method under “Paper search and evaluation reading”), the second added community-suggested evaluations, tutorials, and unverified leads (see the “2026-09-24 community increment” row in the key-facts table). All other sections keep the 09-22 snapshot.
